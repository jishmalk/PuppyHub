...
import Images from  "../Admin/items.png";
...
function Editproducts() {
  ...
  useEffect(() => {
    // Set default values for rdio buttons when the component mounts
              ...
              >
                ...
                <span>
                  ...
                  <input
                    type="radio"
                    name="ctg"
                    checked={elementCtg === "Toy"}
                    onChange={() => setElementCtg("Toy")}
                  />
                  Toy
                  <input
                    type="radio"
                    name="ctg"
                    checked={elementCtg === "Medicine"}
                    onChange={() => setElementCtg("Medicine")}
                  />
                  Medicine
                </span>
                {/* <strong>Type:</strong>
